  ...
  'relative w-full rounded-xl border px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg~*]:pl-7',
  {
    variants: {
      variant: {
        ...
        warning:
          'border-amber-300/50 text-amber-700 dark:border-amber-700 [&>svg]:text-amber-600 bg-amber-50',
        success:
          'border-emerald-300/50 text-emerald-700 dark:border-emerald-700 [&>svg]:text-emerald-600 bg-emerald-50',
      },
    },
    defaultVariants: {
      variant: 'default',
